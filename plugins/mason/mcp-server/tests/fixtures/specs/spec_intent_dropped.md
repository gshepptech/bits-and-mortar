...
# Spec: spec-intent-dropped

*Phase 8 fixture — same shape as spec_intent_clean.md but A-005 (the bcrypt implicit-fact) is present in the Appendix yet NOT cited anywhere in casting-1-prompt-dropped.md. Drives the DROPPED-bearing matrix scenario.*
...
- A-005 implicit-fact constraint verified at acceptance.
