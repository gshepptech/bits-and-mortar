...
- **Run directory**: `mason-archive/{run_name}/` — write output to `mason-archive/{run_name}/research/{domain-slug}-RESEARCH.md`
...
Write to: `mason-archive/{run_name}/research/{domain-slug}-RESEARCH.md`
...
```json
{
  ...
  "output": "mason-archive/{run}/research/kubernetes-deployments-listing-RESEARCH.md",
  "confidence": "HIGH",
...
- **NEVER modify code.** You only write to `mason-archive/{run}/research/`.
